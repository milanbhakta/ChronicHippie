    ...
    $sql_cat="SELECT product.title,product_image.src,product_variant.price,product_variant.compare_at_price,product_price.*,categories.category from product INNER JOIN product_image ON product_image.product_id = product.id INNER JOIN product_variant ON product_variant.product_id= product.id INNER JOIN product_price ON product_price.product_id= product.id INNER JOIN categories ON product.category_id = categories.id WHERE product.id=$id ORDER BY product.title
      ";
