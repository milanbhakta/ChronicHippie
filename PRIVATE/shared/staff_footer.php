   ...
   <!-- Footer-->
        ...
        <div class="container">
          <div class="widget w-100 mb-4 pb-3 text-center mx-auto" style="max-width: 28rem;">
            ...
            <form class="cz-subscribe-form validate" action="https://studio.us12.list-manage.com/subscribe/post?u=c7103e2c981361a6639545bd5&amp;amp;id=29ca296126" method="post" name="mc-embedded-subscribe-form" target="_blank" novalidate>
              ...
              </div><small class="form-text text-light opacity-50">*Receive early discount offers, updates and new products info.</small>
    ...
    <script>
                                      ...
                                      function getproduct(){
                                        var val=document.getElementById('unp-category').value;
                                        ...
                                        if(val!=='disableall'){
                                          ...
                                          document.getElementById('unp-category').disabled=false;;
