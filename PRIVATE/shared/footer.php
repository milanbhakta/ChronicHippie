...
<!-- Footer-->
          ...
          <div class="col-md-4 col-sm-6">
            <div class="widget widget-links widget-light pb-2 mb-4">
              ...
              <ul class="widget-list">
                <li class="widget-list-item"><a class="widget-list-link" href="">Flowers</a></li>
            <li class="widget-list-item"><a class="widget-list-link" href="">Concentrates</a></li>
                <li class="widget-list-item"><a class="widget-list-link" href="">Edibles</a></li>
                <li class="widget-list-item"><a class="widget-list-link" href="">Gears</a></li>
                <li class="widget-list-item"><a class="widget-list-link" href="">Vape Pens</a></li>
                <li class="widget-list-item"><a class="widget-list-link" href="">Topicals</a></li>
                <li class="widget-list-item"><a class="widget-list-link" href="">CBD</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-4 col-sm-6">
            <div class="widget widget-links widget-light pb-2 mb-4">
              <h3 class="widget-title text-light">Shipping info</h3>
              <ul class="widget-list">
        ...
        <div class="container">
          ...
          <div class="row pb-2">
            <div class="col-md-6 text-center text-md-left mb-4">
              <div class="text-nowrap mb-4"><a class="d-inline-block align-middle mt-n1 mr-3" href="#"><img class="d-block" width="117" src="img/Logo.jpeg" alt="CHRONIC HIPPIE"/></a>
          ...
          <div class="pb-4 font-size-xs text-light opacity-50 text-center text-md-left">© All rights reserved. Made by <a class="text-light" href="milanbhakta.tk" target="_blank" rel="noopener">MILAN BHAKTA</a></div>
        </div>
      </div>
    </footer>
    ...
    <div class="cz-handheld-toolbar">
      <div class="d-table table-fixed w-100">
        <!-- <a class="d-table-cell cz-handheld-toolbar-item" href="account-wishlist.html">-->
          <!-- <span class="cz-handheld-toolbar-icon"><i class="czi-heart"></i></span><span class="cz-handheld-toolbar-label">Wishlist</span></a>-->
    ...
    <script>
      function detailsmodal(id)
      {
        ...
        jQuery.ajax({
          url:'../private/shared/modalview.php',
          type:'post',
          data: data,
          success:function(){
            jQuery('body').append(data);
            jQuery('#quick-view').modal('toggle'); 
          },
          error:function(){
      ...
      jQuery('#product-size').change(function(){
       
        var available=jQuery('#product-size option:selected').data('available');
      ...
      function add_to_cart(){
        ...
        var size=jQuery('#product-size').val();
        ...
        if(quantity>available){
           error+='<div class="alert alert-primary" role="alert">There are only '+available+' available.</div>';
       
           jQuery('#display').html(error);
          
          return;
        }else{
          
           jQuery.ajax({
            url: '/CH4/PRIVATE/shared/add_cart.php',
            method: 'post',
            data:data,
            success:function(l){
              alert(l); 
