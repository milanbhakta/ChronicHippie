<?php
 $sql_cat="SELECT product.*,categories.category from product INNER JOIN categories ON product.category_id = categories.id WHERE product.Featured=1 ORDER BY product.title";
 ...
 ?>  
  ...
  <!-- Page title-->
    ...
    <section class="cz-carousel cz-dots-enabled">
      <div class="cz-carousel-inner" data-carousel-options='{"loop": true,"speed": 1000, "autoplay": true, "autoplayTimeout": 5000 }'>
        <!-- Item-->
        <div class="px-lg-5" style="background-color: #ffffff;">
          <div class="d-lg-flex justify-content-between align-items-center pl-lg-4"><img class="d-block order-lg-2 mr-lg-n5 flex-shrink-0" src="img/banners/Banner.jpg" alt="Summer Collection">
             <div class="position-relative mx-auto mr-lg-n5 py-5 px-4 mb-lg-5 order-lg-1" style="max-width: 42rem; z-index: 10;">
              <div class="pb-lg-5 mb-lg-5 text-center text-lg-left text-lg-nowrap">
                ...
                <p class="font-size-lg text-light pb-3 from-left delay-2">much more...</p><a class="btn btn-primary scale-up delay-4" href="shop-grid-ls.html">Shop Now<i class="czi-arrow-right ml-2 mr-n1"></i></a>
              </div>
            </div> 
          </div>
        </div>
        <!-- Item-->
        <div class="px-lg-5" style="background-color: #00000">
          <div class="d-lg-flex justify-content-between align-items-center pl-lg-4"><img class="d-block order-lg-2 mr-lg-n5 flex-shrink-0" src="img/banners/Banner2.jpg" alt="Women Sportswear">
            <div class="position-relative mx-auto mr-lg-n5 py-5 px-4 mb-lg-5 order-lg-1" style="max-width: 42rem; z-index: 10;">
              <div class="pb-lg-5 mb-lg-5 text-center text-lg-left text-lg-nowrap">
                <h2 class="text-light font-weight-light pb-1 from-bottom">Hurry up! L</h2>
                <h1 class="text-light display-4 from-bottom delay-1"></h1>Sale</h1>
                <p class="font-size-lg text-light pb-3 from-bottom delay-2">much more...</p><a class="btn btn-primary scale-up delay-4" href="shop-grid-ls.html">Shop Now<i class="czi-arrow-right ml-2 mr-n1"></i></a>
              </div>
            </div>
          </div>
        </div>
    ...
    <section class="container pt-md-3 pb-5 mb-md-3">
      ...
      <?php
        ...
        <div class="card product-card">
          ...
          <span class="badge badge-primary badge-shadow">Deal</span>
          <?php endif?>
           <!-- <button class="btn-wishlist btn-sm" type="button" data-toggle="tooltip" data-placement="left" title="Add to wishlist" ><i class="czi-heart"></i>-->
           </button><a class="card-img-top d-block overflow-hidden" href="includes/productdetails.php?id=<?=$parent['id']?>"><img src="<?= $parent['img_src']?>" alt="Product"></a> 
            <div class="card-body py-2"><a class="product-meta d-block font-size-xs pb-1" href="#"><?php echo $parent['category']?></a>
              <h3 class="product-title font-size-sm"><a href="includes/productdetails.php?id=<?=$parent['id']?>"><?php echo $parent['title']?></a></h3>
              <div class="d-flex justify-content-between">
                ...
                <?php  $price=explode(".",$parent['price'])?>$<?php echo $price[0]?><small>.<?php echo $price[1]?></small></span>
                  ...
                  <?php  $compare_price=explode(".",$parent['compare_price'])&&$parent['compare_price']>0?>$<?php echo $compare_price[0]?><small>.<?= $compare_price[1]?></small></span></del>
                  <?php endif?>
                </div>
            ...
            <div class="text-center pb-4">
              ...
              <div class="text-center">
               ...
               <a class="btn btn-primary btn-sm"  onclick="detailsmodal(<?=$parent['id'];?>)"><i class="czi-eye align-middle mr-1"></i>Quick view</a>
              </div> 
            </div>
          </div>
          <hr class="d-sm-none">
